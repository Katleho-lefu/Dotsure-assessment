  ...
  <nav>
    <div class="max-w-10xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-20">
        <div class="flex items-center">
          <div class="ml-15 lg:ml-24 text-lg flex-shrink-0 tracking-[.18em]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="147.703"
              height="16"
              viewBox="0 0 147.703 16"
            >
              <g
                id="Group_20268"
                data-name="Group 20268"
                transform="translate(-120 -46.288)"
                opacity="0.87"
              >
                <path
                  id="Path_15979"
        ...
        <div class="hidden md:block">
          <div
            class="flex ml-10 gap-8 text-sm font-light items-center tracking-[.08em]"
          >
    ...
    <div :class="[isOpen ? '' : 'hidden', 'md:hidden']">
      <div class="px-2 pt-2 pb-3 sm:px-3">
        ...
        <a
          href="#"
          class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white focus:outline-none focus:text-white focus:bg-gray-700"
          >CONTACT US</a
        >
      </div>
    </div>
